...
class LegalPages extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        DB::table('legal_pages')->insert([
            [
                ...
                'status' => '1',
                'description' => '<h2><strong>Terms and Conditions</strong></h2>
            ...
            [
                ...
                'slug' => 'privacy-policy',
                'status' => '1',
                'description' => '<h1>Privacy Policy for Auto Tradia</h1>
            ...
            [
                ...
                'slug' => 'refund-policy',
                'status' => '1',
                'description' => '<h1>Return and Refund Policy</h1>
