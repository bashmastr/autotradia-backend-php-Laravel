        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">Trashed News List</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="">Home</a>
                                </li>
                                <li class="breadcrumb-item active">Trashed news list
                                </li>
                            </ol>
                        </div>
                    </div>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                   ...
                                   <tr>
                                    ...
                                    <td>{{$news->name}}</td>
                                    <td>       @if ($news->assignNewsCategory->count() > 0)
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="{{route('admin.news.restore',['id'=>$news->id])}}">
                                                  <i data-feather="refresh-ccw" class="mr-50"></i>
                                                    <span>Restore</span>
                                                </a>
                                               
                                                <form action="{{route('admin.news.forceDelete',['id'=>$news->id])}}" method="POST">
                                                    @csrf
