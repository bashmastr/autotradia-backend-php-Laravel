        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">Categories List</h2>
            ...
            <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
                <div class="form-group breadcrumb-right">
                    <div class="dropdown">
                        <a href="{{route('category.create')}}" class="btn-icon btn btn-primary btn-round btn-sm dropdown-toggle">Add New</a>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                   ...
                                   <tr>
                                    ...
                                    <td> <a class="dropdown-item" href="{{route('admin.categories.status',['id'=>$category->id])}}" class="btn btn-dark">
