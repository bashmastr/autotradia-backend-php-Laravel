                                    ...
                                    <div class="card">
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="input-group input-group-merge">
                                                            ...
                                                            <input type="text" id="fname-icon" class="form-control" name="name" placeholder="Ad Title" />
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="input-group input-group-merge">
                                                            ...
                                                            <input type="text" id="fname-icon" class="form-control" name="price" placeholder="Ad Price" />
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    <div class="col-sm-3 col-form-label">
                                                        <label for="contact-icon">Phone</label>
                                                    </div>
                                                    <div class="col-sm-9">
                                                        <div class="form-label-group">
                                                            <input type="number" min="1" class="form-control" id="label-textarea"  placeholder="Phone Number" name="phone">
                                ...
                                <div class="card">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="input-group input-group-merge">
                                                        ...
                                                        <input type="text" id="fname-icon" class="form-control" name="car_model" placeholder="Car model" />
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="input-group input-group-merge">
                                                        ...
                                                        <input type="text" id="fname-icon" class="form-control" name="company" placeholder="Car Company " />
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="input-group input-group-merge">
                                                        ...
                                                        <input type="text" id="fname-icon" class="form-control" name="car_color" placeholder="Car Company " />
                                        ...
                                        <div class="col-12">
                                            <div class="form-group row">
                                                <div class="col-sm-3 col-form-label">
                                                    <label for="fname-icon">Available City </label>
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="input-group input-group-merge">
                                                        ...
                                                        <input type="text" id="fname-icon" class="form-control" name="available_city" placeholder="Available City  " />
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="input-group input-group-merge">
                                                        ...
                                                        <input type="text" id="fname-icon" class="form-control" name="milage" placeholder="milage" />
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="input-group input-group-merge">
                                                        ...
                                                        <input type="text" id="fname-icon" class="form-control" name="condition" placeholder="Car condition " />
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="input-group input-group-merge">
                                                        ...
                                                        <input type="text" id="fname-icon" class="form-control" name="engine" placeholder="Car engine " />
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="input-group input-group-merge">
                                                        ...
                                                        <input type="text" id="fname-icon" class="form-control" name="registeration_no" placeholder="Car registeration no " />
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="input-group input-group-merge">
                                                        ...
                                                        <input type="text" id="fname-icon" class="form-control" name="registeration_city" placeholder="Car Registeration city " />
