        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">Events List</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="">Home</a>
                                </li>
                                <li class="breadcrumb-item active">Events list
                                </li>
                            </ol>
                        </div>
                    </div>
            ...
            <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
                <div class="form-group breadcrumb-right">
                    <div class="dropdown">
                        <a href="{{route('event.create')}}" class="btn-icon btn btn-primary btn-round btn-sm dropdown-toggle">Add New</a>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                   ...
                                   <tr>
                                    ...
                                    <td>
                                        <div class="avatar-group">
                                            ...
                                            <div data-toggle="tooltip" data-popup="tooltip-custom" data-placement="top" title="" class="avatar" data-original-title="{{$event->name}}">
                                                <img src="{{asset('images/events/'.$event->image)}}" alt="{{$event->image}}" height="80" width="80" />
                                            </div>
                                        </div>
                                    </td>
                                    <td>{{$event->name}}</td>
                                    ...
                                    @if ($event->status=='1')
                                    <td> <a class="dropdown-item" href="{{route('admin.event.status',['id'=>$event->id])}}" class="btn btn-dark">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="{{route('event.edit',['event'=>$event->id])}}">
